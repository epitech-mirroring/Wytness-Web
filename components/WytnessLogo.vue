...
const getSizeClass = () =>
  ["sm", "md", "lg", "xl"].includes(props.size)
...
<template>
  <div id="wytness-logo" @click="onClick">
    <svg
      v-if="props.withLogo"
      :class="[getLogoSizeClass(), '-mr-2']"
      viewBox="0 0 476 374"
      fill="none"
...
#wytness-logo {
  ...
  #wytness-text {
    ...
    @apply font-bold text-primary tracking-tighter;
  }
}
</style>
