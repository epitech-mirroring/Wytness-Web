...
const { user, googleAuth } = useAuthState();
...
<template>
  ...
  >
    ...
    >
      <div class="w-full flex flex-col justify-center items-center py-5">
        ...
        <p class="text-slate-500">Enter your details to create an account</p>
      </div>
      <div
  ...
  <button class="gsi-material-button mt-4" style="width:350px;" @click="signInWithGoogle">
