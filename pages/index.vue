  ...
  >
    <header class="w-full p-6 mt-20 text-center">
      ...
      <p class="text-xl text-gray-600 mt-4">
        Revolutionize the way you integrate and automate your workflows.
      </p>
    </header>
    ...
    <main class="flex flex-col items-center w-full">
      ...
      <section
        class="mt-20 mb-8 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl"
      >
        <FeatureCard
          title="Connect"
        ...
        <FeatureCard
          title="Automate"
          description="Eliminate repetitive tasks with powerful workflows."
          :icon="automateIcon"
        />
        <FeatureCard
          title="Simplify"
        ...
        <div class="max-w-6xl mx-auto">
          ...
          <div class="grid grid-cols-3 md:grid-cols-6 gap-4">
            ...
            >
              ...
              />
              <p class="mt-3 text-md font-medium text-gray-700">
                {{ service.name }}
              </p>
            </div>
          </div>
      ...
      <section class="pt-10 w-full bg-blue-50 py-10">
        <div
          class="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:justify-between px-6 md:px-12"
        >
          <div class="text-center md:text-left">
            <h2 class="text-3xl font-bold text-gray-800">Download the App</h2>
            <p class="mt-2 text-gray-600">
              Get the best experience on your mobile device. Available on iOS
              and Android.
            </p>
          </div>
          <div class="ms-6 mt-6 md:mt-0 flex justify-center gap-4">
            ...
            >
              <img
                src="/assets/images/badges/appstore.svg"
            ...
            >
              <img
                src="/assets/images/badges/playstore.png"
